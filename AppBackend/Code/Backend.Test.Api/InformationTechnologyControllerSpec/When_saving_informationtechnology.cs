...
{
    public class When_saving_informationtechnology : UsingInformationTechnologyControllerSpec
    {
        ...
        public override void Context()
        {
            ...
            _informationtechnologyService.Save(_informationtechnology).Returns(_informationtechnology);
        }
        ...
        {
            _informationtechnologyService.Received(1).Save(_informationtechnology);
        ...
        public void Appropriate_result_is_returned()
        {
            ...
            var resultList = (InformationTechnology)resultListObject;
