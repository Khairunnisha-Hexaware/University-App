...
{
    public class When_deleting_informationtechnology : UsingInformationTechnologyControllerSpec
    {
        ...
        public override void Context()
        {
            ...
            _informationtechnologyService.Delete(Id).Returns(true);
        }
        ...
        {
            _informationtechnologyService.Received(1).Delete(Id);
