...
{
    public class When_saving_electricalandelectronicsengineering : UsingElectricalandElectronicsEngineeringControllerSpec
    {
        ...
        public override void Context()
        {
            ...
            _electricalandelectronicsengineeringService.Save(_electricalandelectronicsengineering).Returns(_electricalandelectronicsengineering);
        }
        ...
        {
            _electricalandelectronicsengineeringService.Received(1).Save(_electricalandelectronicsengineering);
        ...
        public void Appropriate_result_is_returned()
        {
            ...
            var resultList = (ElectricalandElectronicsEngineering)resultListObject;
